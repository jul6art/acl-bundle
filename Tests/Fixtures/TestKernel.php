...
final class TestKernel extends Kernel
{
    ...
    {
        return \sprintf('%s/jul6art-acl-bundle-tests/%s/%s', sys_get_temp_dir(), $this->uniqueId, $this->environment);
    }

    private function configure(ContainerBuilder $container): void
    {
        $container->loadFromExtension('framework', [
            'secret' => 'jul6art-acl-bundle-tests',
            ...
            'orm' => [
                ...
                'mappings' => [
                    'AclBundleTests' => [
                        'type' => 'attribute',
                        'dir' => __DIR__.'/Entity',
                        'prefix' => 'Jul6Art\AclBundle\\Tests\\Fixtures\\Entity',
                        'is_bundle' => false,
                    ],
                ],
            ],
